...
const Page = () => {
		...
		<div>
			...
			<div className='md:pl-60 md:ml-0 ml-6'>
				...
				<div className='flex justify-center mt-10 w-full'>
					<Button className='text-center w-2/12' onClick={toggleIsClicked}>Save</Button>
				</div>
			</div>
			</div> :
			<div> 
  ...
  <div className='relative'>
    ...
    <Button className='absolute bottom-1 right-0'   onClick={handleFileUploadClick}><Pencil size={15} /></Button>
  </div>
</div>
			...
			<div className='md:pl-60 md:mx-auto w-full my-14'>
				...
				<div className='flex justify-center mt-10 w-full'>
					<Button className='text-center w-2/12 md:ml-40 ' onClick={toggleIsClicked}>Edit</Button>
				</div>
			</div>
			</div>
